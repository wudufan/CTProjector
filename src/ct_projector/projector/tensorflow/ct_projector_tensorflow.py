...
class SiddonConeFP(tf.keras.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        return self.projector.siddon_cone_fp_arbitrary(
            inputs, geometry, grid, detector, output_shape, self.default_shape
        )
...
class SiddonConeBP(tf.keras.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        return self.projector.siddon_cone_bp_arbitrary(
            inputs, geometry, grid, detector, output_shape, self.default_shape
        )
